...
const ProductDetails3Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Image
        source={{
          uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-04-20%20225425-1xQafjBpaDk3tU6EZLrWcaw68SRtmg.png",
        }}
