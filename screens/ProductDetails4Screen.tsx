...
const ProductDetails4Screen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Image
        source={{
          uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-04-20%20225451-1TzntRxOaPgnkf9RSzAELIKN352USg.png",
        }}
...
export default ProductDetails4Screen
